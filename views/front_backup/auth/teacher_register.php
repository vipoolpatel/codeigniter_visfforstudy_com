...
?>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url();?>assets/auth/teacher_register.css">
...
<div class="container text-center">
	<div class="col-lg-12 d-inline-block main-register">
		...
		<div class="">
		<div class="mt-2 mb-2"><img class="img-fluid" src="<?=base_url()?>assets/auth/teacher_register/teamwork.png"><span><?=get_phrase('free_registration')?></span></div>
		<div class="mt-2 mb-2"><img class="img-fluid" src="<?=base_url()?>assets/auth/teacher_register/get-hired.png"><span><?=get_phrase('access_thousands_of_students_for_free')?></span></div>
		<div class="mt-2 mb-2"><img class="img-fluid" src="<?=base_url()?>assets/auth/teacher_register/video.png"><span><?=get_phrase('free_online_classes')?></span></div>
		<div class="mt-2 mb-2"><img class="img-fluid" src="<?=base_url()?>assets/auth/teacher_register/book.png"><span><?=get_phrase('payment_guaranteed_for_each_lecture')?></span></div>
	</div>
		</div>
	</div>
</div>
...
?>
		...
		<script src="<?=base_url()?>assets/auth/teacher_register/js/jquery-migrate-3.0.0.min.js"></script>
		<script src="<?=base_url()?>assets/auth/teacher_register/js/jquery.backstretch.min.js"></script>
        <script src="<?=base_url()?>assets/auth/teacher_register/js/wow.min.js"></script>
