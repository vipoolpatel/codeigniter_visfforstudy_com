				    ...
				    <div class="tab-content">
                        <div class="os-tabs-w bg-white">
                            <ul class="navs navs-tabs upper centered">
                                <li class="navs-item">
                                    <a class="navs-links active" href="<?=base_url()?>teacher/chat" style="color:#000"><i class="os-icon picons-thin-icon-thin-0306_chat_message_discussion_bubble_conversation" style="color:#047bf8"></i><span>Chats</span></a>
                                </li>
                                <li class="navs-item">
                                    <a class="navs-links " href="" style="color:#000"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new" style="color:#047bf8"></i><span>Write</span></a>
                                </li>
                                <li class="navs-item">
                                    <a class="navs-links" href="" style="color:#000"><i class="os-icon picons-thin-icon-thin-0719_group_users_circle" style="color:#047bf8"></i><span>Groups</span></a>
                                </li>
                            </ul>
                        </div>
                      				...
                      				<div class="user-w box ">
                        				...
                        				<div class="user-info">
                                            ...
                                            You: hi...                                       
                          					...
                          					<div class="last-message"><a class="badge badge-secondary" href="" style="color:white">Teacher</a>
                          					</div>
                        				</div>
                        			</div>
                      			</a>
