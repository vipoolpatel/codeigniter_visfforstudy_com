...
<div class="top-header-thumb">
	...
	<div class="top-header-author">
		...
		<div class="author-content">
			<a href="javascript:void(0);" class="h3 author-name">Admins</a>
...
<div class="profile-section" style="background-color: #fff;">
	<div class="control-block-button">
		<a href="<?=base_url()?>panel/admin/add_admin" class="btn btn-control bg-purple" style="background:#0084ff; color: #fff;">
                ...
                <div class="card-box widget-user ui-block list">
                    <div class="more" style="float:right;">
                            ...
                            <ul class="more-dropdown">
                                <li><a href="<?=base_url()?>panel/admin/admin_update/<?=$value->id?>">Edit</a></li>
                                <li><a onClick="return confirm('Do you want to delete the information?')" href="<?=base_url();?>panel/admin/detele_admin/<?=$value->id?>">Delete</a></li>
                            </ul>
                        </div>
                    <div>
<?php
...
?>
                        ...
                        <div class="wid-u-info">
                            <a href="<?=base_url()?>panel/admin/admin_profile/<?=$value->id?>" class="h6 author-name"><h5 class="mt-0 m-b-5"> <?=$value->first_name?> <?=$value->last_name?></h5></a>
