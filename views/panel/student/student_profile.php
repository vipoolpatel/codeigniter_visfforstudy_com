                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="value-pair">
                                      ...
                                      <div class="value badge badge-pill badge-success">Student admin</div>
                                  </div>
                                  <div class="value-pair">
                  ...
                  <div class="crumina-sticky-sidebar">
                      ...
                      <ul class="help-support-list">
                        <li>
                          ...
                          <a href="<?=base_url()?>panel/student/student_profile/<?=$list->id?>">Personal information</a>
                        </li>
                        <li>
                          <i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                          <a href="<?=base_url()?>panel/student/student_update/<?=$list->id?>">Update information</a>
                        </li>
                      </ul>
                    </div>
                  </div>
