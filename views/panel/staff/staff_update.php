                              ...
                              <div class="user-avatar-w">
                                 <div class="user-avatar">
                                  <?php
                                    ...
                                    if (!empty($edit_data->profile_pic) && file_exists($datas)) {
                                    ?>
                  ...
                  <div class="crumina-sticky-sidebar">
                      ...
                      <ul class="help-support-list">
                        <li>
                          ...
                          <a href="<?=base_url()?>panel/staff/staff_profile/<?=$edit_data->id?>">Personal information</a>
                        </li>
                        <li>
                          <i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                          <a href="<?=base_url()?>panel/staff/staff_update/<?=$edit_data->id?>">Update information</a>
                        </li>
                      </ul>
                    </div>
                  </div>
