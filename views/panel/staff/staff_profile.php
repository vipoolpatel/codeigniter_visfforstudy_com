                           ...
                           <div class="user-avatar-w">
                             <div class="user-avatar">
                               <?php
                                ...
                                if (!empty($list->profile_pic) && file_exists($datas)) {  ?>
                              ...
                              <h5 class="up-sub-header">@Staff</h5>
                          </div>
                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="value-pair">
                                      ...
                                      <div class="value badge badge-pill badge-success">Staff admin</div>
                                  </div>
                                  <div class="value-pair">
                  ...
                  <ul class="widget w-personal-info item-block">
                     <li>
                      ...
                      <span class="text">
                        ...
                        <img alt="" width="100px" src="<?=base_url()?>backed/uploads/profile/<?=$list->profile_pic?>" style="background-color:#fff;">
                  ...
                  <div class="crumina-sticky-sidebar">
                      ...
                      <ul class="help-support-list">
                        <li>
                          ...
                          <a href="<?=base_url()?>panel/staff/staff_profile/<?=$list->id?>">Personal information</a>
                        </li>
                        <li>
                          <i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                          <a href="<?=base_url()?>panel/staff/staff_update/<?=$list->id?>">Update information</a>
                        </li>
                      </ul>
                    </div>
                  </div>
