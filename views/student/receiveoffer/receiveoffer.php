                           ...
                           <article class="hentry post has-post-thumbnail thumb-full-width">
                              ...
                              <div class="col-sm-12">
                                 <div class="form-group label-floating">
                                    <label><b>  <?=get_phrase('title')?> : </b> <?=$value->title?></label>
                                 </div>
                              </div>
                              <div class="col-sm-12">
                                 <div class="form-group label-floating">
                              ...
                              <div class="col-sm-12">
                                 <div class="form-group label-floating">
                                    <label><b>
                                    <?=get_phrase('lesson_date_&_time')?> : </b><span style="color: #0084ff;">  <?=date('d-m-Y', $value->lesson_time);?>; <?=date('h:i:A', $value->lesson_time);?></span></label>
                                 </div>
                              </div>
                              <div class="col-sm-12">
                                 <div class="form-group label-floating">
                              ...
                              <div class="col-sm-12">
                                 <div class="form-group label-floating">
                                    <label><b>
                                    <?=get_phrase('price_for_lesson')?> : </b> <span style="color: #0084ff;">$<?=$value->hour_per_rate?>/Lesson</span></label>
                                 </div>
                              </div>
                              <div class="col-sm-12">
                                 <div class="form-group label-floating">
                              ...
                              <div class="col-sm-12"> 
                                 <a href="<?=base_url();?>student/receiveoffer/view_receiveoffer/<?=$value->id?>"> <button class="send-btn btn btn-info "> <?=get_phrase('view')?></button>  </a>
                                 <?php
