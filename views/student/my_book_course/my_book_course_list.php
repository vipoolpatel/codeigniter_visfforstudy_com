      ...
      <div class="os-tabs-controls">
         <ul class="navs navs-tabs upper">
            <li class="navs-item">
               ...
               <span>My Book Course List</span></a>
            </li>
         </ul>
      </div>
   </div>
                     ...
                     <table class="table table-padded">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="bolder">
                                 <a href="<?=base_url()?>student/course/view_course/<?=$value->course_id?>" style="color:grey;"><i style="font-size:20px;" class="picons-thin-icon-thin-0012_notebook_paper_certificate" data-toggle="tooltip" data-placement="top" data-original-title="View details"></i></a>
                                 <?php
